...
const STORAGE_KEY_LAYOUT = 'satcs-analytics-layout-v7';
const STORAGE_KEY_VISIBLE = 'satcs-analytics-visible-v7';
const STORAGE_KEY_FILTERS = 'satcs-analytics-filters-v7';
